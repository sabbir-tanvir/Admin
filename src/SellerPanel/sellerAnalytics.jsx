...
import { getSellerInfo } from '../services/api';

function SellerAnalytics() {
    // Chart demo data (could later come from API endpoints)
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                console.warn('Seller info fetch error:', e?.response?.data || e.message);
            } finally {
        ...
        <div className="seller-analytics">
            ...
            <div className="analytics-overview">
                <StatCard
                    ...
                    iconClass="icon-blue"
                    number={loading ? '...' : String(sellerStats.total_sales)}
                    stats={[
                        {
                ...
                <StatCard
                    ...
                    number={loading ? '...' : `$${sellerStats.total_revenue}`}
                    stats={[
                        {
                ...
                <StatCard
                    ...
                    number={loading ? '...' : String(sellerStats.total_orders)}
                    stats={[
                        {
