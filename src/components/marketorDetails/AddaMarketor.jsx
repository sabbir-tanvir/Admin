...
import styles from '../../styles/marketorDetails/AddaMarketor.module.css';
...
function AddMarketor() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error('Register marketer failed', err);
      ...
      toast.error(msg || 'Failed to create marketer');
    } finally { setSubmitting(false); }
  };

  return (
    <div className={styles['add-marketer-page']}>
      <div className={styles['add-marketer-container']}>
        <h1 className={styles['page-title']}>Add a Marketer</h1>
            ...
            <div className={styles['form-section']}>
              <div className={styles['input-row']}>
                <div style={{ position:'relative' }}>
                  ...
                  <button type="button" onClick={()=>setShowPassword(s=>!s)} style={{ position:'absolute', right:8, top:8, background:'none', border:'none', cursor:'pointer', fontSize:12 }}>
