...
function Dashboard() {
        ...
        (async () => {
            try {
                ...
                if (mounted && Array.isArray(data)) {
                    ...
                    const transformedData = data.slice(0, 4).map(customer => ({
                        name: customer.first_name,
                        contact: customer.phone_number,
                        orders: customer.total_orders,
                        avatar: null // Will use placeholder generated from first letter of name
                    }));
                    setTopCustomers(transformedData);
                }
            } catch (e) {
                console.warn('Top Customers fetch error:', e?.response?.data || e.message);
            } finally {
                // no-op
            }
        })();
    ...
    const customerIcon = (
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none">
            ...
            <defs>
                <filter id="filter0_d_307_575" x="0" y="6" width="70" height="52" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
    ...
    const salesIcon = (
        <svg xmlns="http://www.w3.org/2000/svg" width="71" height="71" viewBox="0 0 71 71" fill="none">
            <path d="M38.7245 16.009L47.4531 24.7953L53.497 59.038L23.5483 64.3438L17.5044 30.1011L22.6948 18.849L38.7245 16.009Z" fill="#FFAF1A" fillOpacity="0.5" stroke="black" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M33.4884 21.7674C33.5416 22.0268 33.5422 22.2943 33.4904 22.554C33.4385 22.8136 33.3351 23.0603 33.1863 23.2793C33.0375 23.4984 32.8464 23.6854 32.6241 23.8294C32.4018 23.9733 32.153 24.0712 31.8922 24.1174C31.6315 24.1636 31.3641 24.157 31.1059 24.0981C30.8477 24.0392 30.604 23.9292 30.389 23.7745C30.1741 23.6199 29.9923 23.4237 29.8544 23.1976C29.7166 22.9715 29.6254 22.7201 29.5863 22.4582C29.5331 22.1988 29.5324 21.9314 29.5843 21.6717C29.6362 21.412 29.7396 21.1653 29.8884 20.9463C30.0371 20.7272 30.2283 20.5402 30.4506 20.3963C30.6729 20.2523 30.9217 20.1544 31.1825 20.1082C31.4432 20.0621 31.7106 20.0686 31.9688 20.1275C32.2269 20.1864 32.4707 20.2964 32.6856 20.4511C32.9006 20.6058 33.0824 20.8019 33.2202 21.028C33.3581 21.2541 33.4493 21.5055 33.4884 21.7674Z" fill="#FFAF1A" fillOpacity="0.5" stroke="black" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M28.0806 6.65625C28.3956 10.9473 29.2787 17.3358 31.2327 20.4894L28.0806 6.65625Z" fill="#FFAF1A" fillOpacity="0.5" />
            <path d="M28.0806 6.65625C28.3956 10.9473 29.2787 17.3358 31.2327 20.4894" stroke="black" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M30.2505 7.92834C30.5212 13.774 31.5004 21.6964 30.5508 20.6004L30.2505 7.92834ZM43.4313 40.0484C44.4934 39.4198 46.4178 38.4924 47.147 39.0707C47.9369 39.6949 47.3881 41.4522 46.8423 42.8367" fill="#FFAF1A" fillOpacity="0.5" />
            <path d="M30.2505 7.92834C30.5212 13.774 31.5004 21.6964 30.5508 20.6004M43.4313 40.0484C44.4934 39.4198 46.4178 38.4924 47.147 39.0707C47.9369 39.6949 47.3881 41.4522 46.8423 42.8367" stroke="black" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M22.5752 44.2537C24.6061 45.2595 30.2772 46.3482 35.9365 45.3453C41.331 44.3898 44.3042 41.9935 45.8173 40.5824" fill="#FFAF1A" fillOpacity="0.5" />
            <path d="M22.5752 44.2537C24.6061 45.2595 30.2772 46.3482 35.9365 45.3453C41.331 44.3898 44.3042 41.9935 45.8173 40.5824" stroke="black" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
    ...
    return (
        <div className={styles['dashboard']}>
            <div className={styles['dashboard-cards']}>
                ...
                <div className={styles['dashboard-main-layout']}>
                    {/* Left Section */}
                    <div className={styles['dashboard-left']}>
                        {/* Upper row: 2 TotalCards side by side */}
                        <div className={styles['dashboard-left-upper']}>
                            <TotalCard
                                title="Total Order"
                                icon={orderIcon}
                        ...
                        <div className={styles['dashboard-left-lower']}>
                            <OrderStatCard
            ...
            <div className={styles['item-boxs']}>
                <div className={styles['item-box']}>
                    <div className={styles['item-box-header']}>
